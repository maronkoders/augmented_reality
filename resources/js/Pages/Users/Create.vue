    ...
    <div class="max-w-3xl bg-white rounded-md shadow overflow-hidden">
      <form @submit.prevent="store">
        <div class="flex flex-wrap -mb-8 -mr-6 p-8">
          ...
          <select-input v-model="form.user_type_id" :error="form.errors.user_type_id" class="pb-8 pr-6 w-full lg:w-1/2" label="User Type">
            <option  v-for="(t,i) in UserTypes" :key="i" :value="t.id">{{t.name}}</option>
          </select-input>
